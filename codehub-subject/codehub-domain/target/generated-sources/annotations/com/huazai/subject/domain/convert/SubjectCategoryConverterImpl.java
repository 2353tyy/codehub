...
public class SubjectCategoryConverterImpl implements SubjectCategoryConverter {
    ...
    @Override
    public List<SubjectCategoryBO> convertBoToCategory(List<SubjectCategory> subjectCategoryBO) {
        if ( subjectCategoryBO == null ) {
            return null;
        }

        List<SubjectCategoryBO> list = new ArrayList<SubjectCategoryBO>( subjectCategoryBO.size() );
        for ( SubjectCategory subjectCategory : subjectCategoryBO ) {
